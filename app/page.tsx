...
export default function Home() {
  ...
  return <main><div className="ambient ambient-one" /><div className="ambient ambient-two" />
    ...
    <section className="trust-strip"><div><strong>{lang === "th" ? "หน่วยถูกต้อง" : "Correct units"}</strong><span>SI conversion</span></div><div><strong>{lang === "th" ? "ตรวจสอบย้อนกลับ" : "Traceable logic"}</strong><span>{lang === "th" ? "แสดงสูตรในรายงาน" : "Formulas included in reports"}</span></div><div><strong>{lang === "th" ? "รองรับสองภาษา" : "Bilingual"}</strong><span>ไทย / English</span></div></section><footer><span>CalFlow Engineering Toolkit</span><span>Verified workbook logic · 2026</span></footer>
  </main>;
}
